...
namespace Repository.Context
{
    public class AppDbContext : IdentityDbContext<AppUser, AppRole, Guid>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                new Permission { Id = Guid.Parse("00000000-0000-0000-0005-000000000000"), Name = "getUser", Description = "Permite leer la información detallada del usuario.", FrontendRoute = "users", Label = "Usuarios", Order = 2 },
                ...
                new Permission { Id = Guid.Parse("00000000-0000-0000-0006-000000000000"), Name = "getRoles", Description = "Permite leer la información de los roles.", FrontendRoute = "roles", Label = "Roles", Order = 3 },
