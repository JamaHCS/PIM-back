    ...
    public class AppDbContext : IdentityDbContext<AppUser, AppRole, Guid>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            var permissions = new List<Permission>
            {
                ...
                new Permission { Id = Guid.Parse("00000000-0000-0000-0006-000000000000"), Name = "getRoles", Description = "Permite leer la información de los roles.", FrontendRoute = "roles", Label = "Roles", Order = "3", Icon = "pi pi-users" },
